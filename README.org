...
This is an updated version of the 2013 work presented by Dr Alexander Lundervold (http://alexander.lundervold.com/) in GitHub (see https://github.com/alu042/SDE-higham). We all code is updated/converted to run in Python 3.
